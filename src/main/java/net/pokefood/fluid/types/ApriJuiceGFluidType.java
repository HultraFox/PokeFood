...
public class ApriJuiceGFluidType extends FluidType {
	public ApriJuiceGFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_g_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_g_flow");
