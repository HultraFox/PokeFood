...
public class RoseradeTeaFluidType extends FluidType {
	public RoseradeTeaFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/roserade_tea_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/roserade_tea_flow");
