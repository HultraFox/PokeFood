...
public class BlackTeaFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/blacktea_still"),
					FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/blacktea_flow");
