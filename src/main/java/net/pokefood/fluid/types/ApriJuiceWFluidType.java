...
public class ApriJuiceWFluidType extends FluidType {
	public ApriJuiceWFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_w_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_w_flow");
