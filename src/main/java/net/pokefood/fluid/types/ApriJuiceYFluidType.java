...
public class ApriJuiceYFluidType extends FluidType {
	public ApriJuiceYFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_y_still"),
					FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_y_flow");
