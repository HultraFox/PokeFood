...
public class RedWineFluidType extends FluidType {
	public RedWineFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/red_wine_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/red_wine_flow");
