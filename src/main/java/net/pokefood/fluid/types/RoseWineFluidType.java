...
public class RoseWineFluidType extends FluidType {
	public RoseWineFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/rose_wine_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/rose_wine_flow");
