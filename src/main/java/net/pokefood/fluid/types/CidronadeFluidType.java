...
public class CidronadeFluidType extends FluidType {
	public CidronadeFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/cidronade_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/cidronade_flow");
