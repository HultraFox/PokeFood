...
public class ApriJuiceDFluidType extends FluidType {
	public ApriJuiceDFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_d_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/aprijuice_d_flow");
