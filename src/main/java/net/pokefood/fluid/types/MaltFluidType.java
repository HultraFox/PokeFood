...
public class MaltFluidType extends FluidType {
	public MaltFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("pokefood:blocks/malt_still"), FLOWING_TEXTURE = new ResourceLocation("pokefood:blocks/malt_flow");
