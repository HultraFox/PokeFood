...
public class InfuseOrBoilRecipeCategory implements IRecipeCategory<InfuseOrBoilRecipe> {
	public final static ResourceLocation UID = new ResourceLocation("pokefood", "infuse_or_boil");
	public final static ResourceLocation TEXTURE = new ResourceLocation("pokefood", "textures/screens/cooking_pot_jei.png");
	private final IDrawable background;
	private final IDrawable icon;

	public InfuseOrBoilRecipeCategory(IGuiHelper helper) {
	...
	@Override
	public mezz.jei.api.recipe.RecipeType<InfuseOrBoilRecipe> getRecipeType() {
		return PokefoodModJeiPlugin.InfuseOrBoil_Type;
	}
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, InfuseOrBoilRecipe recipe, IFocusGroup focuses) {
