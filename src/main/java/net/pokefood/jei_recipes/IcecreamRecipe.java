...
public class IcecreamRecipe implements Recipe<SimpleContainer> {
	private final ResourceLocation id;
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public IcecreamRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.id = id;
		this.output = output;
	...
	public static class Type implements RecipeType<IcecreamRecipe> {
		private Type() {
		}
	...
	public static class Serializer implements RecipeSerializer<IcecreamRecipe> {
		...
		public static final ResourceLocation ID = new ResourceLocation("pokefood", "icecream");
		...
		public IcecreamRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
			...
			return new IcecreamRecipe(pRecipeId, output, inputs);
		}
		...
		public @Nullable IcecreamRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
			...
			return new IcecreamRecipe(id, output, inputs);
		}
