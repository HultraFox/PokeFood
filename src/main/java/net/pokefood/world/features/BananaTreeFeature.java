...
public class BananaTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static BananaTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BananaTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("pokefood:banana_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("pokefood:banana_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
