...
public class BigOvenGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BigOvenGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
