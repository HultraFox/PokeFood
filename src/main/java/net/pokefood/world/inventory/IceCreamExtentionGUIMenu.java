...
public class IceCreamExtentionGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IceCreamExtentionGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PokefoodModMenus.ICE_CREAM_EXTENTION_GUI.get(), id);
