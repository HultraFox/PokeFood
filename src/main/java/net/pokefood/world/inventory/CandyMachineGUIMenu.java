...
import net.pokefood.network.CandyMachineGUISlotMessage;
...
public class CandyMachineGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PokefoodMod.PACKET_HANDLER.sendToServer(new CandyMachineGUISlotMessage(slotid, x, y, z, ctype, meta));
			CandyMachineGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
