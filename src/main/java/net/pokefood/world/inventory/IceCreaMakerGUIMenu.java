...
public class IceCreaMakerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IceCreaMakerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PokefoodModMenus.ICE_CREA_MAKER_GUI.get(), id);
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 106, 62) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
