...
public class MixingGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MixingGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PokefoodModMenus.MIXING_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 106, 8) {
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 106, 62) {
		}));
