...
@Mod("pokefood")
public class PokefoodMod {
	public static final Logger LOGGER = LogManager.getLogger(PokefoodMod.class);
	public static final String MODID = "pokefood";
