...
public class BlackTeaCollectingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == PokefoodModBlocks.BLACK_TEA_STAGE_2.get()) {
			if (!world.isClientSide()) {
				...
				world.setBlock(BlockPos.containing(x, y, z), PokefoodModBlocks.BLACK_TEA_STAGE_0.get().defaultBlockState(), 3);
			}
		}
	}
}
