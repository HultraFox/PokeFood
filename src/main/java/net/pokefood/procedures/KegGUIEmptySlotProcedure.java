...
public class KegGUIEmptySlotProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		ItemStack slot4 = ItemStack.EMPTY;
		ItemStack slot5 = ItemStack.EMPTY;
		ItemStack slot6 = ItemStack.EMPTY;
		ItemStack slot7 = ItemStack.EMPTY;
