...
import net.pokefood.item.inventory.WarpedBurgerInventoryCapability;
...
public class WarpedBurgerItem extends Item {
	public WarpedBurgerItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new WarpedBurgerInventoryCapability();
	}
