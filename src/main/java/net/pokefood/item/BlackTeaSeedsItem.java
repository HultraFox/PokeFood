...
import net.pokefood.procedures.BlackTeaPlantingProcedure;
...
public class BlackTeaSeedsItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		BlackTeaPlantingProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
