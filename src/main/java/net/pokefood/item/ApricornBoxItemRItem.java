...
import net.pokefood.item.inventory.ApricornBoxItemRInventoryCapability;
...
public class ApricornBoxItemRItem extends Item {
	public ApricornBoxItemRItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ApricornBoxItemRInventoryCapability();
	}
