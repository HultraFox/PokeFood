...
import net.pokefood.item.inventory.ApricornBoxItemPInventoryCapability;
...
public class ApricornBoxItemPItem extends Item {
	public ApricornBoxItemPItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ApricornBoxItemPInventoryCapability();
	}
