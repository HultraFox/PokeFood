...
import net.pokefood.procedures.CandyBoxItemUpdateProcedure;
import net.pokefood.item.inventory.CandyBoxItemInventoryCapability;
...
public class CandyBoxItemItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new CandyPackagerMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		CandyBoxItemUpdateProcedure.execute(itemstack);
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new CandyBoxItemInventoryCapability();
	}
