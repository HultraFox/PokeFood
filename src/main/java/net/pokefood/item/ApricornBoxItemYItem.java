...
import net.pokefood.item.inventory.ApricornBoxItemYInventoryCapability;
...
public class ApricornBoxItemYItem extends Item {
	public ApricornBoxItemYItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ApricornBoxItemYInventoryCapability();
	}
