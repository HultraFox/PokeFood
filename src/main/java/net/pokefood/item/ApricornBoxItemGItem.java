...
import net.pokefood.item.inventory.ApricornBoxItemGInventoryCapability;
...
public class ApricornBoxItemGItem extends Item {
	public ApricornBoxItemGItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ApricornBoxItemGInventoryCapability();
	}
