...
import net.pokefood.item.inventory.ApricornBoxItemWInventoryCapability;
...
public class ApricornBoxItemWItem extends Item {
	public ApricornBoxItemWItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ApricornBoxItemWInventoryCapability();
	}
