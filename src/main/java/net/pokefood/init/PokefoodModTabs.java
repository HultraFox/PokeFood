...
public class PokefoodModTabs {
	...
	public static final RegistryObject<CreativeModeTab> POKE_FOOD = REGISTRY.register("poke_food",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food")).icon(() -> new ItemStack(PokefoodModItems.PUFF_FANCY_PEPPER.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(PokefoodModItems.DONUT.get());
				tabData.accept(PokefoodModItems.DONUT_LIME.get());
				tabData.accept(PokefoodModItems.DONUT_GREEN_GRAPES.get());
				tabData.accept(PokefoodModItems.DONUT_LEMON.get());
				tabData.accept(PokefoodModItems.DONUT_BANANA.get());
				tabData.accept(PokefoodModItems.DONUT_APPLE.get());
				tabData.accept(PokefoodModItems.DONUT_GLOW_BERRIES.get());
				tabData.accept(PokefoodModItems.DONUT_MELON.get());
				tabData.accept(PokefoodModItems.DONUT_SWEET_BERRIES.get());
				tabData.accept(PokefoodModItems.DONUT_CHERRY.get());
				tabData.accept(PokefoodModItems.DONUT_BLACK_GRAPES.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_RED.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_BLUE.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_PINK.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_GREEN.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_YELLOW.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_WHITE.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_RED_PLUS.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_BLUE_PLUS.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_PINK_PLUS.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_GREEN_PLUS.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_YELLOW_PLUS.get());
				tabData.accept(PokefoodModItems.POKEBLOCK_WHITE_PLUS.get());
				...
				tabData.accept(PokefoodModBlocks.CHERRY_CAKE.get().asItem());
				tabData.accept(PokefoodModBlocks.CHOCOLATE_CAKE.get().asItem());
				tabData.accept(PokefoodModBlocks.BANANA_CAKE.get().asItem());
				tabData.accept(PokefoodModBlocks.BLACK_GRAPES_CAKE.get().asItem());
				tabData.accept(PokefoodModBlocks.SWEET_BERRIES_PIE.get().asItem());
				tabData.accept(PokefoodModBlocks.APPLE_PIE.get().asItem());
				tabData.accept(PokefoodModBlocks.LEMON_PIE.get().asItem());
				tabData.accept(PokefoodModBlocks.LIME_PIE.get().asItem());
				tabData.accept(PokefoodModItems.CHOCOLATE_CAKE_SLICE.get());
				tabData.accept(PokefoodModItems.CHERRY_CAKE_SLICE.get());
				tabData.accept(PokefoodModItems.BANANA_CAKE_SLICE.get());
				tabData.accept(PokefoodModItems.BLACK_GRAPES_CAKE_SLICE.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_PIE_SLICE.get());
				tabData.accept(PokefoodModItems.LEMON_PIE_SLICE.get());
				tabData.accept(PokefoodModItems.LIME_PIE_SLICE.get());
				tabData.accept(PokefoodModItems.APPLE_PIE_SLICE.get());
	...
	public static final RegistryObject<CreativeModeTab> POKE_FOOD_OTHERS = REGISTRY.register("poke_food_others",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food_others")).icon(() -> new ItemStack(PokefoodModBlocks.CARDBOARD_BOX.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(PokefoodModItems.TRAY.get());
				tabData.accept(PokefoodModItems.THIN_BOTTLE.get());
				tabData.accept(PokefoodModItems.JAR.get());
				...
				tabData.accept(PokefoodModBlocks.COOKING_POT.get().asItem());
				...
				tabData.accept(PokefoodModBlocks.BLENDER.get().asItem());
				...
				tabData.accept(PokefoodModBlocks.CURRY_POT.get().asItem());
	...
	public static final RegistryObject<CreativeModeTab> POKE_FOOD_BUILDING = REGISTRY.register("poke_food_building",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food_building")).icon(() -> new ItemStack(PokefoodModBlocks.RESTAURANT_SOFA_CORNER_5.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(PokefoodModBlocks.POKE_BOWL_0.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_1.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_2.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_3.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_4.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_5.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_6.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_7.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_0.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_1.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_2.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_3.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_4.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_5.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_6.get().asItem());
				tabData.accept(PokefoodModBlocks.POKE_BOWL_UNCOOKED_7.get().asItem());
				tabData.accept(PokefoodModBlocks.COFFEE_BOARD.get().asItem());
				tabData.accept(PokefoodModBlocks.COFFEE_BOARD_TALL.get().asItem());
				tabData.accept(PokefoodModBlocks.EXTERIOR_COFFEE_BOARD.get().asItem());
			})
	...
	public static final RegistryObject<CreativeModeTab> POKE_FOOD_INGREDIENTS = REGISTRY.register("poke_food_ingredients",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food_ingredients")).icon(() -> new ItemStack(PokefoodModItems.SPICY_JUICE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(PokefoodModItems.BUN.get());
				...
				tabData.accept(PokefoodModItems.LIME_JUICE.get());
				tabData.accept(PokefoodModItems.GREEN_GRAPES_JUICE.get());
				tabData.accept(PokefoodModItems.LEMON_JUICE.get());
				tabData.accept(PokefoodModItems.BANANA_JUICE.get());
				tabData.accept(PokefoodModItems.APPLE_JUICE.get());
				tabData.accept(PokefoodModItems.GLOW_BERRIES_JUICE.get());
				tabData.accept(PokefoodModItems.MELON_JUICE.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_JUICE.get());
				tabData.accept(PokefoodModItems.CHERRY_JUICE.get());
				tabData.accept(PokefoodModItems.BLACK_GRAPES_JUICE.get());
				tabData.accept(PokefoodModItems.LIME_JAM.get());
				tabData.accept(PokefoodModItems.GREEN_GRAPES_JAM.get());
				tabData.accept(PokefoodModItems.LEMON_JAM.get());
				tabData.accept(PokefoodModItems.BANANA_JAM.get());
				tabData.accept(PokefoodModItems.APPLE_JAM.get());
				tabData.accept(PokefoodModItems.GLOW_BERRIES_JAM.get());
				tabData.accept(PokefoodModItems.MELON_JAM.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_JAM.get());
				tabData.accept(PokefoodModItems.CHERRY_JAM.get());
				tabData.accept(PokefoodModItems.BLACK_GRAPES_JAM.get());
	...
	public static final RegistryObject<CreativeModeTab> POKE_FOOD_ON_THE_GO = REGISTRY.register("poke_food_on_the_go",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food_on_the_go")).icon(() -> new ItemStack(PokefoodModItems.CALCUIM_BOX_11.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(PokefoodModItems.BURGER_BEEF.get());
				tabData.accept(PokefoodModItems.BURGER_BEEF_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_BEEF_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_PORK.get());
				tabData.accept(PokefoodModItems.BURGER_PORK_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_PORK_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_MUTTON.get());
				tabData.accept(PokefoodModItems.BURGER_MUTTON_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_MUTTON_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_GREEN.get());
				tabData.accept(PokefoodModItems.BURGER_GREEN_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_GREEN_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_FAIRY.get());
				tabData.accept(PokefoodModItems.BURGER_FAIRY_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_FAIRY_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_FLUFFY.get());
				tabData.accept(PokefoodModItems.BURGER_FLUFFY_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_FLUFFY_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_NIDO.get());
				tabData.accept(PokefoodModItems.BURGER_NIDO_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_NIDO_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_BLUE.get());
				tabData.accept(PokefoodModItems.BURGER_BLUE_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_BLUE_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_HORSE.get());
				tabData.accept(PokefoodModItems.BURGER_HORSE_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_HORSE_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_LUV.get());
				tabData.accept(PokefoodModItems.BURGER_LUV_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_LUV_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_BAS.get());
				tabData.accept(PokefoodModItems.BURGER_BAS_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_BAS_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_KARP.get());
				tabData.accept(PokefoodModItems.BURGER_KARP_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_KARP_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_KING.get());
				tabData.accept(PokefoodModItems.BURGER_KING_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_KING_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_DEEN.get());
				tabData.accept(PokefoodModItems.BURGER_DEEN_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_DEEN_SPICY.get());
				tabData.accept(PokefoodModItems.BURGER_FRIED.get());
				tabData.accept(PokefoodModItems.BURGER_FRIED_CHEESE.get());
				tabData.accept(PokefoodModItems.BURGER_FRIED_SPICY.get());
				...
				tabData.accept(PokefoodModItems.TO_GO_FRIES_0.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_1.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_2.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_3.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_4.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_5.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_6.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_7.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_8.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_9.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_10.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_11.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_12.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_13.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_14.get());
				tabData.accept(PokefoodModItems.TO_GO_FRIES_15.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_0.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_1.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_2.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_3.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_4.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_5.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_6.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_7.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_8.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_9.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_10.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_11.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_12.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_13.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_14.get());
				tabData.accept(PokefoodModItems.TO_GO_LEEK_15.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_0.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_1.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_2.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_3.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_4.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_5.get());
				tabData.accept(PokefoodModItems.SWEET_BERRIES_TO_GO_6.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_0.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_1.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_2.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_3.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_4.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_5.get());
				tabData.accept(PokefoodModItems.CHEESE_BALLS_TO_GO_6.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_0.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_1.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_2.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_3.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_4.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_5.get());
				tabData.accept(PokefoodModItems.BEETROOT_TO_GO_6.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_0.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_1.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_2.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_3.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_4.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_5.get());
				tabData.accept(PokefoodModItems.CACTUS_CUBES_TO_GO_6.get());
				...
				tabData.accept(PokefoodModItems.CALCUIM_BOX_15.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> POKE_FOOD_EMPTY_BOXES = REGISTRY.register("poke_food_empty_boxes",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.pokefood.poke_food_empty_boxes")).icon(() -> new ItemStack(PokefoodModItems.CALCUIM_BOX_EMPTY_6.get())).displayItems((parameters, tabData) -> {
				tabData.accept(PokefoodModItems.TO_GO_BAG_0.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_1.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_2.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_3.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_4.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_5.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_6.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_7.get());
				tabData.accept(PokefoodModItems.TO_GO_BAG_8.get());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_0.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_1.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_2.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_3.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_4.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_5.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_6.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_7.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_8.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_9.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_10.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_11.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_12.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_13.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_14.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_SMALL_15.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_0.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_1.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_2.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_3.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_4.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_5.get().asItem());
				tabData.accept(PokefoodModBlocks.TO_GO_MEDIUM_6.get().asItem());
